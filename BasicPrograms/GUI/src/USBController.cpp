...
bool USBController::stop(){
    ...
    this->interpreter.getQuadCommand().setAutoThrottle(true);
...
void USBController::update(){
    ...
    js_event js;
        ...
        this->interpreter.getQuadCommand().setTargetPitch((this->tear[PITCH] - 50) * 0.7 * (3.14/180));
        this->interpreter.getQuadCommand().setTargetRoll((this->tear[ROLL] - 50) * 0.7 * (3.14/180));
        this->interpreter.getQuadCommand().setTargetDirection((this->tear[YAW] - 50) * 0.7 * (3.14/180));
